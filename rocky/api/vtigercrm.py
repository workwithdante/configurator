...
def getSalesOrderData(basicDict, dependentDict, payDict, contactID) -> dict:
	...
	return {
		...
		'cf_2357': spouse[0]['ssn']['value']['value'] if len(spouse) > 0 else '',
		'cf_2359': spouse[0]['gender']['value'] if len(spouse) > 0 else '',
		'cf_2355': spouse[0]['dob']['value'] if len(spouse) > 0 else '',
		'cf_2631': spouse[0]['pob']['value'] if len(spouse) > 0 else '',
		...
		'cf_2389': '' if len(spouse) == 0 else ('OBAMACARE' if len(spouse) > 1 and spouse[0]['coverage']['label'] == 'Yes' else ('MEDICAID' if len(spouse) > 1 and spouse[0]['coverage']['label'] == 'Medicaid' else None)),
		...
		'cf_2413': dependent[0]['dob']['value'] if len(dependent) >= 1 else '',
		...
		'cf_2431': '' if len(dependent) == 0 else ('HIJO(A)' if len(dependent) >= 1 and  dependent[0]['relationship']['value'] == 'Children' else ('ABUELO(A)' if len(dependent) >= 1 and  dependent[0]['relationship']['value'] == 'Grandparent' else ('PADRE/MADRE' if len(dependent) >= 1 and dependent[0]['document']['value'] == 'Parent' else ''))),
		...
		'cf_2451': dependent[1]['dob']['value'] if len(dependent) >= 2 else '',
		...
		'cf_2465': '' if len(dependent) <= 1 else ('HIJO(A)' if len(dependent) >= 2 and  dependent[1]['relationship']['value'] == 'Children' else ('ABUELO(A)' if len(dependent) >= 2 and  dependent[1]['relationship']['value'] == 'Grandparent' else ('PADRE/MADRE' if len(dependent) >= 1 and dependent[0]['document']['value'] == 'Parent' else ''))),
		...
		'cf_2487': dependent[2]['dob']['value'] if len(dependent) >= 3 else '',
		...
		'cf_2501': '' if len(dependent) <= 2 else ('HIJO(A)' if len(dependent) >= 3 and  dependent[2]['relationship']['value'] == 'Children' else ('ABUELO(A)' if len(dependent) >= 1 and  dependent[2]['relationship']['value'] == 'Grandparent' else ('PADRE/MADRE' if len(dependent) >= 1 and dependent[0]['document']['value'] == 'Parent' else ''))),
		...
		'cf_2523': dependent[3]['dob']['value'] if len(dependent) >= 4 else '',
		...
		'cf_2537': '' if len(dependent) <= 3 else ('HIJO(A)' if len(dependent) >= 4 and  dependent[3]['relationship']['value'] == 'Children' else ('ABUELO(A)' if len(dependent) >= 4 and  dependent[3]['relationship']['value'] == 'Grandparent' else ('PADRE/MADRE' if len(dependent) >= 1 and dependent[0]['document']['value'] == 'Parent' else ''))),
		...
		'cf_2681': dependent[4]['dob']['value'] if len(dependent) >= 5 else '',
		...
		'cf_2699': '' if len(dependent) <= 4 else ('HIJO(A)' if len(dependent) >= 1 and  dependent[4]['relationship']['value'] == 'Children' else ('ABUELO(A)' if len(dependent) >= 5 and  dependent[4]['relationship']['value'] == 'Grandparent' else ('PADRE/MADRE' if len(dependent) >= 1 and dependent[0]['document']['value'] == 'Parent' else ''))),
